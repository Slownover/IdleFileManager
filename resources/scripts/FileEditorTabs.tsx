...
const MediaViewer: React.FC<{
    ...
    useEffect(() => {
        http.get(`/api/client/servers/${serverId}/files/download`, {
            params: { file: path },
        })
            .then((res) =>
                setUrl(
    ...
    monacoReady = new Promise<void>((resolve, reject) => {
        ...
        (window as any).MonacoEnvironment = {
            getWorkerUrl(_: string, label: string) {
                ...
                const w =
                    workers[label] ?? `${MONACO_CDN}/editor/editor.worker.js`;
        ...
        <div className="ide-editor-panel">
                ...
                {!activeTab && (
                    <div className="ide-editor-welcome">
                        <div className="ide-editor-welcome__inner">
                            ...
                            <p className="ide-editor-welcome__title">
                                No file open
                            </p>
                ...
                {activeTab &&
                    ...
                    !isVideo(activeTab.name) && (
                        <div className="ide-editor-incompatible">
                            ...
                            <h2 className="ide-editor-incompatible__title">
                                Binary file
                            </h2>
                            <p className="ide-editor-incompatible__desc">
                                <strong>{activeTab.name}</strong> is a binary
                                file ({getBinaryTypeLabel(activeTab.name)}) and
                                cannot be displayed.
                            </p>
                        </div>
                    )}
            ...
            {activeTab && (
                <div className="ide-statusbar">
                    <span className="ide-statusbar__path">
                        {activeTab.path}
                    </span>
